<template>
	<view>
		...
		<view style="width: 520rpx;height: 60rpx; padding-top: 32rpx; text-align: center; margin: 0 auto;">
			<u-button type="primary" shape="circle" @click="chooseImg">上传包含数字图片</u-button>
		</view>
		<view v-if="show">
			...
			<view style="padding-top: 30rpx;background-color: #f2f2f2;">
				<u-cell-group style="width: 100%;"><u-cell-item title="应用场景" title-width="60rpx" value="快递面单识别" :arrow="false"></u-cell-item></u-cell-group>
			</view>
		</view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		getInfo: function(tk) {
			// 发起请求获取信息
			uni.request({
				url: 'https://aip.baidubce.com/rest/2.0/ocr/v1/numbers?access_token=' + tk,
				// 请求方式
				method: 'POST',
				// 请求头
				header: {
		...
		confirm(){
			uni.redirectTo({
			    url: '/pages/ImageTechnology/Numbers/Numbers'
			});
		}
	}
};
